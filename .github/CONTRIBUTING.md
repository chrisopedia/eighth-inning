...
* Go to <https://github.com/iamnewton/eighth-inning/pulls> and open a new pull request with your changes and fill out the template with the appropriate information.
